...
using Fcs.Identity.WebApi.Filters;
using Fcs.Identity.WebApi.Observability;
using Fcs.Identity.WebApi.Seed;
using Fcs.Identity.WebApi.Settings;
using Fcs.Identity.WebApi.Swagger;
using Serilog;
...
public static class DependencyInjection
{
    public static IServiceCollection AddWebApi(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddFilters();
        services.AddHealthChecks().AddDbContextCheck<FcsIdentityDbContext>();
    ...
    private static void AddSerilogLogging(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        Log.Information("Starting {Application} application", "Fcs.Identity");
